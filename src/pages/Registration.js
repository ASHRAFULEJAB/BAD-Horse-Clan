...
import horse2 from "../assets/horse2.json";
...
const Registration = () => {
  return (
    <div className="w-full h-full lg:flex">
      <div
        style={{
          background: `url(${horse3})`,
        }}
        class=" mt-10 mb-10 w-full max-w-md p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800"
      >
        ...
        <div class="flex items-center justify-between mt-4">
          <span class="w-1/5 border-b dark:border-gray-200 lg:w-1/5"></span>
      ...
      <div className="flex items-center mt-0 justify-center h-70 w-80 ">
        <Lottie animationData={horse2} loop={true}></Lottie>
      </div>
    </div>
  );
};
